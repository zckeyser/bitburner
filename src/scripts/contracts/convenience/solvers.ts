/**
 * I took this from https://github.com/jjclark1982/bitburner-scripts/blob/main/contracts/solvers.js
 * because I want to focus on other stuff/new mechanics rather than writing a solver script
 */
